...
1. **`public-service-data-quality`** — *current active flagship; PR and
   ...
   handoff matrix, 39-row human-validation worksheet, 39-row AI closure audit, 10-stage evidence ladder, 4-row source-repair public-evidence attachment, 4-row official-coordinate evidence, 4-row public-explanation
