...
def main():
    ...
    source_rows = [
        ...
        source_row(
            ...
            len(ADB_NAMES),
            len(poverty_values),
            "source label mismatch documented",
            (
                f"Current WDI metadata name is '{poverty_record['indicator_name']}'. "
                "Older program prose labels this as $2.15/day 2017 PPP."
            ),
        ),
        source_row(
    ...
    summary = {
        ...
        "owner_gated_or_unfinished_steps": [
            ...
            "The WDI poverty indicator label in current metadata is $3.00/day 2021 PPP; old prose said $2.15/day 2017 PPP.",
    ...
    combined["social_protection_data_wall"] = (
        ...
        "SI.POV.DDAY as $3.00/day 2021 PPP, while older program prose labels it $2.15/day 2017 PPP."
    )
