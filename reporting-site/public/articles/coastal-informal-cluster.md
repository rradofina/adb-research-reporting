...
topics: [coastal cities, low elevation, urban growth, GHSL, measurement]
program: coastal-informal-risk
maturity: PP
abstract: >
  Across 1,334 GHS-UCDB urban centres with reported low-elevation fields in 24
  ADB developing economies, population recorded below 10 metres increased from
  237.3 million in 2000 to 328.2 million in 2020. The net increase of 90.9
  million is concentrated: Shanghai, Bangkok, and Dhaka lead, and the top ten
  centres account for 52.1% of positive change. A stricter 5-metre definition
  and 10-, 20-, and 30-year windows preserve the direction. The object measures
  change inside fixed 2025 urban-centre footprints; it does not identify flood
...
slum shares were imputed at the same 10% value. Its sensitivity exercise varied
that common imputation by ±50% and found a stable top five.

That stability was arithmetic. Multiplying rows by the same positive factor
does not test whether their order is credible. More fundamentally, the score
contained no coastline, elevation, urban-centre footprint, flood surface, or
protection measure. It could not locate the settlement process named in the
title.

The replacement starts with a direct public data object. GHS-UCDB R2024A V1.2
provides harmonized information for 11,422 quality-controlled urban centres,
including population and built-up surface below 5 metres and between 5 and 10
...
inside the same 2025 urban-centre footprint. A second measure repeats the
calculation for built-up surface.

The city trajectories show why the unit change matters. The regional total is
not a diffuse pattern: it is assembled from specific, highly unequal centre
changes.

![2000 and 2020 low-elevation population for the centres with the largest increases.](/programs/coastal-informal-risk/generated/charts/coastal-informal-risk-02-centre-dumbbell.svg)

The top five centres account for **38.5%** of all positive population change.
The top ten account for **52.1%**.
...
Only two economies overlap.

![Comparison of the inherited proxy top five and observed centre-aggregation top five.](/programs/coastal-informal-risk/generated/charts/coastal-informal-risk-03-proxy-falsification.svg)

This does not prove that the new list is the correct coastal-risk ranking. It
proves that the old list was not a substitute for spatial measurement. The new
economy totals are still dominated by urban scale and should not be used as a
...
![Population change against built-up-surface change below 10 metres.](/programs/coastal-informal-risk/generated/charts/coastal-informal-risk-07-population-built-corroboration.svg)
...
centre's population fell. Dhaka added 7.3 million low-elevation residents while
the share fell by 4.08 percentage points.

![Absolute population change compared with change in the low-elevation share.](/programs/coastal-informal-risk/generated/charts/coastal-informal-risk-08-absolute-versus-share.svg)

For policy communication, this is a useful warning. A declining percentage can
...
The pre-registered 20-year window was also varied by ±50%. The 10-year results
are +16.6 million below 5 metres and +45.0 million below 10 metres. The 30-year
results are +53.5 million and +155.5 million. All six combinations are
positive.
...
growth is large enough to justify deeper work. A next-stage city study should
join:

1. local relative sea-level, storm-surge, and subsidence surfaces;
2. coastal protection and drainage information;
3. dated administrative and planning boundaries;
4. locally validated tenure, services, housing, or deprivation data; and
5. population and built-up uncertainty checks.

That design could move from exposure growth to risk and policy. Until then,
the honest conclusion is narrower: the population recorded in low-elevation
...
[evidence workspace](/coastal-informal-risk?view=evidence).
