      ...
      <section className="grid grid-cols-12 gap-6 lg:gap-10 my-12">
        ...
        <div className="col-span-12 lg:col-span-9">
          <table className="data-table w-full">
            ...
            <tbody>
              <tr>
                <td><Link to="/" className="ed-link font-mono">/</Link></td>
                <td>Magazine cover for the current issue. Featured findings.</td>
              </tr>
              <tr>
                <td><Link to="/briefs" className="ed-link font-mono">/briefs</Link></td>
                <td><strong>Start here</strong> — research briefs: one page per topic with status, chart, source stack, caveat, next step.</td>
              </tr>
              <tr>
                <td><Link to="/findings" className="ed-link font-mono">/findings</Link></td>
                <td>The articles hub. Long-form working papers, research briefs, and issue notes.</td>
              </tr>
              <tr>
                <td><Link to="/findings/the-first-issue" className="ed-link font-mono">/findings/the-first-issue</Link></td>
                <td>Issue editorial introducing the current finished and screening programs.</td>
              </tr>
              <tr>
                <td><Link to="/research" className="ed-link font-mono">/research</Link></td>
              ...
              <tr>
                <td><Link to="/atlas" className="ed-link font-mono">/atlas</Link></td>
              ...
              <tr>
                <td><Link to="/data" className="ed-link font-mono">/data</Link></td>
                <td>Catalog of every public dataset used. Access-grade chips (A–F).</td>
              </tr>
              <tr>
                <td><Link to="/data/matrix" className="ed-link font-mono">/data/matrix</Link></td>
                <td>Cross-program vulnerability matrix.</td>
              </tr>
              <tr>
                <td><Link to="/archive" className="ed-link font-mono">/archive</Link></td>
                <td>Permanent-archive index. Citation handles for every program.</td>
              </tr>
              <tr>
                <td><Link to="/methods" className="ed-link font-mono">/methods</Link></td>
                <td>Claim-maturity tiers, gate requirements, taste heuristics.</td>
              </tr>
              <tr>
                <td><Link to="/about" className="ed-link font-mono">/about</Link></td>
                <td>The lab itself: mission, governance, AI transparency.</td>
              </tr>
              <tr>
                <td><Link to="/team" className="ed-link font-mono">/team</Link></td>
        ...
        <div className="col-span-12 lg:col-span-9">
          ...
          <ul className="mt-6 space-y-3 text-ink-soft">
            <li className="flex items-baseline gap-3">
              ...
              <span>Drafted, attested, gate-promoted by AI under <Link to="/about#ai" className="ed-link">Constitution §18</Link>. Literature reviews, pre-registrations, internal review, red-team review are all AI-attested. <strong>No human has line-by-line read every cited paper. No external reviewer was contacted.</strong></span>
            </li>
            <li className="flex items-baseline gap-3">
...
node scripts/verify-manifest.mjs`}</pre>
      ...
      <nav className="flex items-center justify-between flex-wrap gap-4 pb-12">
        <Link to="/findings/the-first-issue" className="ed-link font-mono text-xs uppercase tracking-[0.18em]">
          → Read the first issue
        </Link>
        <div className="flex gap-4 flex-wrap">
          <Link to="/research" className="ed-link font-mono text-xs uppercase tracking-[0.18em]">All programs</Link>
          <Link to="/archive" className="ed-link font-mono text-xs uppercase tracking-[0.18em]">Archive</Link>
          <Link to="/methods" className="ed-link font-mono text-xs uppercase tracking-[0.18em]">Methods</Link>
        </div>
      </nav>
    </div>
  );
