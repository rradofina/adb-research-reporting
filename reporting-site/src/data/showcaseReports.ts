...
export const showcaseReports: ShowcaseReport[] = [
  ...
  },
  {
    ...
    status: "verified",
    statusLabel: "Prototype report",
    deck: "Ground-monitor visibility is compared with PM2.5 exposure, GDP context, OpenAQ station coordinates, regulator-source candidates, official station-table extraction, official/OpenAQ reconciliation, a 13-row candidate review worksheet, public OpenAQ metadata evidence, isMonitor source screening, public-feed source screening, a 169-item one-signal review queue, monitor-grade source-language evidence, a 14-source monitor-grade source-validation scan, a 138-row station-review queue, a 66-row exact station method-evidence audit, a 28-row Uzbekistan current/method scan, a Uzbekistan method-policy source scan, a Uzbekistan station-specific source evidence scan, a Uzbekistan status/certification source scan, a 3-row Uzbekistan blocker follow-up, a 3-row Uzbekistan endpoint-consistency check, a 38-row Indonesia/Georgia row-method source scan, a 41-row station-code status/method scan, a 66-row station-grade decision ledger, a 66-row station-method classification audit, a 22-row BMKG operation/maintenance source scan, a 22-row BMKG station-specific status audit, a 22-row BMKG API telemetry/status-field check, a 16-row Georgia report-verification scan, a 24-month Georgia report/export ladder, and a 5-source Georgia verification-policy wall before a monitoring-gap claim is widened.",
    evidencePath: "air-monitoring/georgia-verification-policy.md",
    visual: "Zero-monitor exposure bars, GDP residual scatter, metadata-readiness wall, OpenAQ coordinate map, regulator-source wall, official-source bars, official/OpenAQ reconciliation ladder, candidate station-crosswalk worksheet, public-evidence attachment, isMonitor source-scan decisions, public-feed source-scan decisions, one-signal review wall, monitor-grade evidence ladder, monitor-grade source-validation wall, station-review wall, exact station method-evidence bridge, Uzbekistan stale-reading date wall, station-specific source-evidence wall, status/certification source ladder, 3-row blocker wall, official endpoint disagreement wall, Indonesia/Georgia method-context wall, station-code status/method wall, station-grade decision ledger, station-method classification audit, BMKG operation/maintenance source wall, BMKG station display/certification wall, BMKG API field wall, Georgia report-verification wall, Georgia report/export ladder, and Georgia verification-policy bridge",
    sourceNote: "OpenAQ v3 locations, public regulator and official portal station tables/APIs, Uzhydromet API, Uzhydromet English/Russian/Uzbek station-detail and regional table pages, gov.uz ecology event and commissioning notes, World Bank Tashkent assessment text, UNDP Aral Sea monitoring launch page, Digital Government portal page, BMKG PM2.5 portal/station-detail pages, BMKG public app token route and PM2.5 list/detail APIs, BMKG observation regulation, BMKG daily BAM-1020 inspection SOP, BMKG calibration service/tariff page, BMKG source-level instrument notes, BMKG station-detail raw HTML caches and station-specific status audit records, air.gov.ge station-code API, air.gov.ge monthly report route and XLSX/PDF export routes, air.gov.ge report generator, air.gov.ge monitoring-network and index notes, air.gov.ge Tbilisi plan landing, MEPA Tbilisi air-quality management plan PDF, NEA/MoEPA Georgia sources, Bangladesh, Sri Lanka, Uzhydromet, CEA, Brunei, Malaysia, and Tajikistan source-language checks, WHO ambient air quality database, WDI, and committed source artifacts",
  },
  {
    id: 7,
...
export const showcaseReportDepth: Record<number, ShowcaseReportDepth> = {
  ...
  6: {
    ...
    limitation: "Ground-monitor visibility is not pollution ranking, compliance assessment, or monitor siting adequacy; the reconciliation audit has candidate rows but zero validated joins, the exact-row method audit and decision ledger find raw-value and blocker issues, the Uzbekistan station-specific scan closes the station-ID gate through official detail URLs, the status/certification, blocker, and endpoint-consistency scans add context but still lack explicit current-status and grade closure, the Indonesia/Georgia and station-code scans add exact public row context without grade closure, BMKG station/API telemetry is visible but lacks status/certificate fields, the Georgia report/export ladder keeps verified-report closure at zero, the Georgia verification-policy wall confirms the policy route but not a station-status or verified-closure route, and complete monitor-grade classification plus catchment coverage remain at zero.",
  },
  7: {
...
export const showcaseReportQuality: Record<number, ShowcaseReportQuality> = {
  ...
  6: {
    ...
    nextUpgrade: "For BMKG, move beyond visible station-page telemetry by finding station-specific inspection logs, calibration certificates, status records, or grade-basis evidence; for Georgia, find a station-specific verified report/status/method route beyond the policy note and tested not-verified report/export surface; for Uzbekistan, find an official correction/status/grade record that resolves the exact endpoint disagreements before any catchment denominator is promoted.",
  },
  7: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
