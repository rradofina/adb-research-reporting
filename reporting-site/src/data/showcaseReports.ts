...
export const showcaseReportQuality: Record<number, ShowcaseReportQuality> = {
  ...
  6: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
    qaSummary: "Air-monitoring has a deep public evidence ladder for monitor visibility, station/source reconciliation, monitor-grade blockers, Uzbekistan/BMKG/Georgia source walls, and the station-radius denominator pipeline. The station-radius chain now reaches denominator readiness, source plan, acquisition routes, file-manifest prefreeze, download feasibility, ACAG version decision, and a coarse checksum gate with 2 downloaded ACAG NetCDF files, 2 SHA-256 hashes, and 2 opened NetCDF metadata records, while population denominators, exposure rows, validated joins, maps, and station-radius-ready economies remain at zero.",
    publicationGap: "Needs validated station crosswalk rows, station-level complete monitor-grade classification across sources, a selected and downloaded gridded population denominator subset, SHA-256 checksums for that selected population denominator, frozen radius/de-duplication/join/grade rules, and denominator validation before station-radius or catchment language.",
    nextUpgrade: "For Uzbekistan, find a public station-owner or regulator source beyond the Air Uzbekistan alternate namespace that names station IDs 107, 728, or 737, or explicitly crosswalks them to IDs 1, 20, and 26, with correction/status/calibration or grade-basis closure; for BMKG, target station-specific inspection logs, PM2.5 calibration certificates, calibration-status records, or explicit station-grade records beyond station pages, dashboard status, station studies, installation/deployment context, source-level rules, and the PPID/PTSP access-route wall; for Georgia, find a station-specific verified report/status/method route beyond the policy note, daily/monthly caution routes, annual server-error routes, XLSX station-sheet-only exports, NEA city-level network/launch context, and the indicator API's different station-code namespace; for station-radius work, select a DMC-intersecting population tile/subset, checksum only that selected denominator subset, then freeze radius/de-duplication rules before any catchment map.",
  },
  7: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
