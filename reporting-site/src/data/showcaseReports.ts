...
export const showcaseReportQuality: Record<number, ShowcaseReportQuality> = {
  ...
  6: {
    ...
    nextUpgrade: "For the 22 BMKG rows now carrying operation/maintenance context, find station-specific inspection logs, calibration certificates, status records, or grade-basis evidence; for Georgia and Uzbekistan, find exact station-owner or regulator method/status/certification tables before any catchment denominator is promoted.",
  },
  7: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
