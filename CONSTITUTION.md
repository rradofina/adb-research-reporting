...
| 18 | Public data freshness blind spots | `public-data-freshness/` | **H — qualified L2 hook; active flagship** (prospective 9/18/27-indicator WDI cell-age decomposition frozen before the expanded pull; tests calendar-age versus source-relative review disagreement; `attestation_chain: ai-first`) | 27/30 (AI under §18) | Adofina | 2026-07-19 |
