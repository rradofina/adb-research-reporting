...
| 1 | PSDQ source disagreement | `public-service-data-quality/source-disagreement-l3-module.md`, `public-service-data-quality/facility-validation-sample.md`, `public-service-data-quality/facility-validation-coded-screen.md`, `public-service-data-quality/facility-validation-ai-review.md`, `public-service-data-quality/facility-validation-candidate-resolution.md`, generated L3 strata/sample/coded-screen/AI-review/candidate-resolution artifacts, and PSDQ national summary | Interactive registry-vs-OSM disagreement workbench plus ratio-strata validation ledger, validation-sample panel, grouped coded-screen chart, AI public-source review workstream chart, and candidate-resolution lane chart | L3 evidence module at `/showcase/psdq-source-disagreement`; validation sample, automated coded screen, AI row-review ledger, and 8-row candidate-resolution pass generated; desktop/mobile screenshot QA complete on 2026-06-19 | Public-source confirmation inside candidate-resolution lanes, then coordinate-source repair and high-exposure public-map-gap checks |
