...
- `program/STATUS.md`  `c04a223611d0…`
...
- `program/limitations.md`  `1982f06299ad…`
...
- `shared/versions.json`  `33d0f9b8e8b4…`
...
— Generated 2026-06-19T06:55:57.871Z by `scripts/build-review-packet.mjs`.
