...
**Note (2026-04-25):** `CONSTITUTION.md` §18 (AI-First Operating Mode) is
ACTIVE. While §18 is ACTIVE, `review-external.md` for each program is
filled by the AI red-team-synthesis protocol in §18.4 — synthesized
objections from named candidate institutions' published methodological
positions, with the §18.4 non-claim verbatim. No individual reviewer is
contacted under §18. This file's §sourcing-strategy below identifies the
candidate institutions whose published positions are synthesized; the
identification is AI-permitted under §18, the contact is not.
