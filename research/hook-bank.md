...
1. **Public data freshness blind spots** - L2 completed 2026-06-16 and
   promoted to the active L3 prospectus on 2026-07-19. The frozen design tests
   a two-clock cell-age decomposition rather than a generic stale-data claim.
...
regional station-table pages, 28 station-detail pages, and one official gov.uz
ecology note; parses 93 station rows; matches all 28 target rows to official
regional table rows; finds 28 official station-detail URLs whose numeric path
...
station matches, and 1 negative sentinel detail PM2.5 value; and still keeps
...
| 2 | Air-monitoring observability | `air-monitoring/deepened-results.md`, `air-monitoring/metadata-readiness-audit.md`, `air-monitoring/station-metadata-source-access.md`, `air-monitoring/regulator-source-inventory.md`, `air-monitoring/regulator-station-extraction.md`, `air-monitoring/official-openaq-reconciliation.md`, `air-monitoring/official-openaq-candidate-review.md`, `air-monitoring/official-openaq-candidate-public-evidence.md`, `air-monitoring/official-openaq-candidate-crosswalk-source-scan.md`, `air-monitoring/official-openaq-candidate-public-feed-source-scan.md`, `air-monitoring/one-signal-review-queue.md`, `air-monitoring/monitor-grade-evidence.md`, `air-monitoring/monitor-grade-source-validation-scan.md`, `air-monitoring/monitor-grade-station-review-queue.md`, `air-monitoring/monitor-grade-station-method-evidence.md`, `air-monitoring/generated/air-monitoring-concentration-deepening.json`, `air-monitoring/generated/air-monitoring-adb-panel.json`, `air-monitoring/generated/air-monitoring-metadata-readiness-audit-summary.json`, `air-monitoring/generated/air-monitoring-openaq-station-metadata-summary.json`, `air-monitoring/generated/air-monitoring-regulator-source-inventory-summary.json`, `air-monitoring/generated/air-monitoring-regulator-station-extraction-summary.json`, `air-monitoring/generated/air-monitoring-official-openaq-reconciliation-summary.json`, `air-monitoring/generated/air-monitoring-official-openaq-candidate-review-summary.json`, `air-monitoring/generated/air-monitoring-official-openaq-candidate-public-evidence-summary.json`, `air-monitoring/generated/air-monitoring-official-openaq-candidate-crosswalk-source-scan-summary.json`, `air-monitoring/generated/air-monitoring-official-openaq-candidate-public-feed-source-scan-summary.json`, `air-monitoring/generated/air-monitoring-one-signal-review-queue-summary.json`, `air-monitoring/generated/air-monitoring-monitor-grade-evidence-summary.json`, `air-monitoring/generated/air-monitoring-monitor-grade-source-validation-scan-summary.json`, `air-monitoring/generated/air-monitoring-monitor-grade-station-review-queue-summary.json`, and `air-monitoring/generated/air-monitoring-monitor-grade-station-method-evidence-summary.json` | Zero-monitor population concentration stack plus GDP-adjusted monitor-density residual scatter, exposure/monitor-count panel, station-metadata readiness wall, OpenAQ station-coordinate map, regulator-source gap wall, official-source bars, official/OpenAQ reconciliation ladder, candidate station-crosswalk worksheet, public-evidence attachment, `isMonitor` source-scan decisions, public-feed source-scan decisions, one-signal review wall, monitor-grade evidence ladder, monitor-grade source-validation wall, monitor-grade station-review wall, and exact station method-evidence bridge | Prototype surface at `/showcase/air-monitoring-observability`; station-metadata source pass generated 101 OpenAQ PM2.5 station rows and 101 coordinate rows for 11 of 24 upgrade-queue economies, excluded 2 coordinate-QC rows, with 13 economies still at OpenAQ-visible zero; regulator-source discovery found 9 official inventory/portal candidates, 6 station-count claim rows, 0 monitor-grade classification rows, and 11 targeted-search gaps; official station-source extraction retrieved 9 targeted official sources, normalized 230 official coordinate rows across 5 economies, and found 22 official coordinate rows within 5 kilometers of OpenAQ as a screening diagnostic; official/OpenAQ reconciliation classified 13 near-plus-name candidate rows, 9 near-only candidate rows, 22 name-only-not-near candidate rows, 186 official coordinate rows without either candidate signal, and 0 validated same-station joins; candidate public-evidence audit found 13 owner/provider rows, 6 OpenAQ `isMonitor` true rows, 7 not-`isMonitor` rows, and 0 station-radius-ready rows; candidate crosswalk source scan retrieved 5 public URLs, screened all 6 `isMonitor` candidate rows as separate nearby stations, and kept validated joins at 0; candidate public-feed source scan retrieved 10 public URLs, screened all 7 not-`isMonitor` rows as public-feed nearby rows that are not join-ready, and kept validated joins at 0; one-signal review queue combines 9 near-only rows, 22 name-only-not-near rows, and 138 monitor-grade provenance-only rows into 169 review items while keeping validated joins and station-radius-ready rows at 0; monitor-grade audit covers 239 official-source rows and still finds 0 complete monitor-grade classification rows; monitor-grade source-validation scan retrieves 14 public URLs across 7 economies, covers all 138 provenance-only rows, finds 7 method/equipment or standard/method context source rows, 6 official/automatic context-only source rows, 1 caution source row, and still 0 complete grade or radius-ready rows; station-review queue assigns those 138 provenance-only station rows to 66 method-context rows needing station confirmation, 2 caution-blocked rows, and 70 official-context-only rows, still with 0 current-status confirmed, complete grade, or radius-ready rows; station method-evidence audit joins those 66 method-context rows to exact official rows, finds 66 exact PM2.5 rows with coordinates, separates 28 exact-row instrument hints from 38 exact PM2.5 portal/API rows, and still keeps current-status confirmed, complete grade, and radius-ready rows at 0; station map/source wall/reconciliation, official/OpenAQ, candidate-review, candidate-public-evidence, candidate-crosswalk source-scan, candidate-public-feed source-scan, one-signal, monitor-grade, source-validation, station-review, and exact-row method-evidence panel desktop-mobile QA complete | L3 source-validation package: search public current-status/method documentation for the 28 Uzbekistan exact-row instrument-hint rows first, then the 38 Indonesia/Georgia PM2.5 portal/API rows, keep the 2 caution rows blocked unless clarified, and add gridded population/PM2.5 denominators only after source comparison survives |
...
| 3 | Urbanization depends on the definition | `invisible-urbanization/generated/invisible-urbanization-definition-gap-panel.csv` | Signed GHSL–WDI gap distribution plus administrative-scale and transition diagnostics | Full research story at `/invisible-urbanization`; desktop/mobile QA complete | Reopen only for classification-history or observed service-access evidence |
...
| 10 | Digital availability–use gap | 4 | 5 | 5 | 5 | 19 | L3/L4 complete; promoted to SR |
...
| 10 | Digital availability–use gap | ITU DataHub exact-year 4G/LTE coverage, internet use, 5 GB affordability, and urban/rural use series | Signed availability-minus-use chart with exact-year denominators and source diagnostics | How often does reported network availability run ahead of use, and which evidence is needed before diagnosing why? | Completed deterministic API custody, exact-year joins, ±50% sensitivity, balanced-panel and secondary diagnostics, and 12-figure paper | L3/L4 complete; reopen only for independent household, device, skills, or conditional service-quality evidence |
