...
snapshot, 14 programs have only a hero thumbnail, two have multiple figures,
and two have no generated visual. Only the PSDQ and remittance working papers
embed substantive figures.
...
| `access-services` | 1 | OSM-to-registry access-load comparison; rank-shift slopegraph; worst-ADM1 distribution; Cambodia source comparison; completeness uncertainty. |
