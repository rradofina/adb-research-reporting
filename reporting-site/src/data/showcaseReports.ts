...
export const showcaseReportQuality: Record<number, ShowcaseReportQuality> = {
  ...
  6: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
    qaSummary: "Air-monitoring has a deep public evidence ladder for monitor visibility, station/source reconciliation, monitor-grade blockers, Uzbekistan/BMKG/Georgia source walls, and the station-radius denominator pipeline. The station-radius chain now reaches a country-unioned catchment dry run: 277 coordinate rows, 275 unique coordinate points, 21/21 corrected GHSL population tiles in custody, 2 ACAG coarse PM2.5 files, 2/2 radius-rule sources retrieved, 4 km primary diagnostic radius, 0.5/50 km sensitivity bands, V6.GL.03 2023 0.10-degree coarse annual PM2.5 selected, 831 candidate coordinate-radius GHSL/ACAG joins, 33 country-radius union rows, 33 GHSL unioned population denominators, 22 ACAG union-cell PM2.5 context rows, 0 validated joins, 0 complete monitor-grade rows, and 0 station-radius-ready economies.",
    publicationGap: "Needs validated station crosswalk rows, station-level complete monitor-grade classification across sources, and an explicit coverage-claim gate before station-radius coverage or catchment language.",
    nextUpgrade: "For Uzbekistan, find a public station-owner or regulator source beyond the Air Uzbekistan alternate namespace that names station IDs 107, 728, or 737, or explicitly crosswalks them to IDs 1, 20, and 26, with correction/status/calibration or grade-basis closure; for BMKG, target station-specific inspection logs, PM2.5 calibration certificates, calibration-status records, or explicit station-grade records beyond station pages, dashboard status, station studies, installation/deployment context, source-level rules, and the PPID/PTSP access-route wall; for Georgia, find a station-specific verified report/status/method route beyond the policy note, daily/monthly caution routes, annual server-error routes, XLSX station-sheet-only exports, NEA city-level network/launch context, and the indicator API's different station-code namespace; for station-radius work, keep the unioned catchment wall non-claim until same-station identity and complete grade evidence exist.",
  },
  7: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
