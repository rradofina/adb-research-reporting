...
At most **one** program may hold the "publication-ready" label at any time.
At most **three** programs may hold "screening result" at any time. All other
active programs are capped at "prepared pipeline" or "hypothesis."

This rule exists because quality does not survive parallel maturity pushes.
...
### 10.3 DOI for headline claims
Every publication-ready claim has a Zenodo-archived artifact bundle with a DOI.
The DOI appears in every written output that uses the numbers.

### 10.4 Versioning and errata
When an artifact changes, a new Zenodo version is minted. An `ERRATA.md` at
the program level records the change, reason, and date. Withdrawn claims are
labeled withdrawn, not silently deleted.
...
|---|---|---|---|---|---|---|
| 0 | MPI × nighttime lights decomposition (Asia-Pacific) | `mpi-nighttime-lights/` | H (provisional) | pending | Adofina / Martinez | 2026-04-24 |
| 1 | Climate-adjusted access to services | `luminosity-gap/research/access-services/` | SR | pending rescore | Adofina | 2026-04-24 |
| 2 | Measured digital development gap | `luminosity-gap/research/digital-performance/` | PP | pending rescore | Adofina | 2026-04-24 |
| 3 | Air pollution without air monitors | `luminosity-gap/research/air-monitoring/` | SR | pending rescore | Adofina | 2026-04-24 |
| 4 | Invisible urbanization | `luminosity-gap/research/invisible-urbanization/` | H | pending rescore | Adofina | 2026-04-24 |
| 5 | Climate-health workday loss | `climate-health-workdays/` | H (multi-DMC outdoor-labor × PM2.5 composite computed 2026-04-25; heat layer TODO) | pending | Adofina | 2026-04-25 |
| 6 | Coastal informal settlement risk | `coastal-informal-risk/` | H | pending | Adofina | 2026-04-24 |
| 7 | Disaster recovery lag | `disaster-recovery-lag/` | H (multi-DMC burden layer computed 2026-04-25; 38 ADB DMCs, EM-DAT 2000–2025; awaiting owner attestation) | pending | Adofina | 2026-04-25 |
| 8 | Flood-driven market and service isolation | `flood-market-access/` | H | pending | Adofina | 2026-04-24 |
| 9 | Food price climate transmission | `food-price-climate-transmission/` | H (first-pass macro composite computed 2026-04-25; CPI × ag-imports × food production; climate-transmission NOT yet) | pending | Adofina | 2026-04-25 |
| 10 | Grid reliability under heat | `grid-reliability-heat/` | H (multi-DMC structural-exposure layer computed 2026-04-25; 39 ADB DMCs, 7,071 plants, fuel-Herfindahl per DMC; awaiting owner attestation) | pending | Adofina | 2026-04-25 |
| 11 | Migration and displacement signals | `migration-displacement-signals/` | H (multi-DMC screening computed 2026-04-25; 44 ADB DMCs, UN DESA 2024 bilateral stock; awaiting owner attestation) | pending | Adofina | 2026-04-25 |
| 12 | Port-hinterland trade friction | `port-hinterland-friction/` | H (multi-DMC structural-exposure computed 2026-04-25; WB LPI × WDI imports; awaiting owner attestation) | pending | Adofina | 2026-04-25 |
| 13 | Public service data quality | `public-service-data-quality/` | H (multi-DMC screening artifact computed PHL + BGD 2026-04-25; awaiting owner attestation to promote to SR) | 24/30 (AI-drafted, pending owner sign-off) | Adofina | 2026-04-25 |
| 14 | Remittance resilience gaps | `remittance-resilience/` | H (multi-DMC screening computed 2026-04-25; 44 ADB DMCs, RPW Q1 2025 + WDI BX.TRF.PWKR.DT.GD.ZS, fragility index; awaiting owner attestation) | pending | Adofina | 2026-04-25 |
| 15 | School heat disruption | `school-heat-disruption/` | H (multi-DMC heat × children × PTR composite computed 2026-04-25; 32 DMCs, CCKP + WDI) | pending | Adofina | 2026-04-25 |
| 16 | Social protection shock coverage | `social-protection-shock-coverage/` | H (multi-DMC readiness-gap composite computed 2026-04-25; WDI ASPIRE × Findex × poverty) | pending | Adofina | 2026-04-25 |
| 17 | Water stress and crop concentration | `water-stress-crop-diversification/` | H (multi-DMC water-crop pressure composite computed 2026-04-25; 44 ADB DMCs, WDI indicators; awaiting owner attestation) | pending | Adofina | 2026-04-25 |

**Current WIP allocation under §8.1:**
- Publication-ready (max 1): *none*.
- Screening result (max 3): Access-services, Air-monitoring, and one open slot.
- All other programs are capped at their current label until a slot opens.
