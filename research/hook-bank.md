...
| 1 | PSDQ source disagreement | `public-service-data-quality/source-disagreement-l3-module.md`, `public-service-data-quality/facility-validation-sample.md`, `public-service-data-quality/facility-validation-coded-screen.md`, generated L3 strata/sample/coded-screen artifacts, and PSDQ national summary | Interactive registry-vs-OSM disagreement workbench plus ratio-strata validation ledger, validation-sample panel, and grouped coded-screen chart | L3 evidence module at `/showcase/psdq-source-disagreement`; validation sample and automated coded screen generated; desktop/mobile screenshot QA complete on 2026-06-19 | Manual public-source review: check the 71 flagged rows and compare manual labels with the automated screen |
