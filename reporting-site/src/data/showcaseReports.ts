...
export const showcaseReportQuality: Record<number, ShowcaseReportQuality> = {
  ...
  6: {
    ...
    nextUpgrade: "For the 22 BMKG rows now method-classified, find station-level calibration/status or official grade-basis evidence; for Georgia and Uzbekistan, find exact station-owner or regulator method/status/certification tables before any catchment denominator is promoted.",
  },
  7: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
