...
- `program/STATUS.md`  `daacf836cd9e…`
...
- `program/limitations.md`  `03d8196025b8…`
...
- `shared/versions.json`  `f03c7615b331…`
...
— Generated 2026-06-19T07:22:03.752Z by `scripts/build-review-packet.mjs`.
