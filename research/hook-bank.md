...
| 1 | PSDQ source disagreement | `public-service-data-quality/source-disagreement-l3-module.md`, `public-service-data-quality/facility-validation-sample.md`, generated L3 strata/sample artifacts, and PSDQ national summary | Interactive registry-vs-OSM disagreement workbench plus ratio-strata validation ledger and validation-sample panel | L3 evidence module at `/showcase/psdq-source-disagreement`; validation sample designed; desktop/mobile screenshot QA complete on 2026-06-19 | Public-source coding pass: classify sampled DGHS rows by duplicate naming, classification, coordinate issue, missing public-map point, OSM-only candidate, or unresolved evidence |
