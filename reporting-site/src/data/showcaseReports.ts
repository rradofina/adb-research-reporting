...
export const showcaseReportQuality: Record<number, ShowcaseReportQuality> = {
  ...
  6: {
    ...
    nextUpgrade: "Search station-owner or regulator pages that explicitly name Uzbekistan station IDs or station-specific equipment/status tables, then resolve the 38 Indonesia/Georgia PM2.5 portal/API rows without promoting any catchment denominator until grade evidence is complete.",
  },
  7: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
