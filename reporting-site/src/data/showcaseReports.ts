...
export const showcaseReports: ShowcaseReport[] = [
  ...
  },
  {
    ...
    status: "verified",
    statusLabel: "Prototype report",
    deck: "Ground-monitor visibility is compared with PM2.5 exposure, GDP context, OpenAQ station coordinates, regulator-source candidates, official station-table extraction, official/OpenAQ reconciliation, a 13-row candidate review worksheet, public OpenAQ metadata evidence, isMonitor source screening, public-feed source screening, a 169-item one-signal review queue, monitor-grade source-language evidence, a 14-source monitor-grade source-validation scan, a 138-row station-review queue, a 66-row exact station method-evidence audit, a 28-row Uzbekistan current/method scan, a Uzbekistan method-policy source scan, a Uzbekistan station-specific source evidence scan, a Uzbekistan status/certification source scan, a 3-row Uzbekistan blocker follow-up, a 3-row Uzbekistan endpoint-consistency check, a 4-source Uzbekistan external-context wall, a 4-source Air Uzbekistan portal namespace wall with 28 portal station objects, 3 alternate namespace matches, 0 original blocker-ID detail hits, and 0 closure rows, a 38-row Indonesia/Georgia row-method source scan, a 41-row station-code status/method scan, a 66-row station-grade decision ledger, a 66-row station-method classification audit, a 22-row BMKG operation/maintenance source scan, a 22-row BMKG station-specific status audit, a 22-row BMKG API telemetry/status-field check, a 10-source BMKG regional status/analysis scan that closes current status for Banjarbaru only, a 2-source official BMKG CEWS dashboard status scan that matches all 22 target rows and closes current dashboard status for 21 ONLINE rows while leaving Pekanbaru DELAYED, a 10-source BMKG grade-basis scan that strengthens method, inspection/logbook, calibration, and certificate-context evidence while keeping station-level grade closure at zero, a 16-source BMKG station public-context scan that adds public station or deployment context for 11 rows and station-unit/exact context for 7 rows while keeping certificate/status closure at zero, a 6-source official BMKG installation/audit scan that adds 1 exact station audit/calibration context row and 7 PM2.5 installation/deployment context rows while keeping certificate/status closure at zero, a 22-row BMKG near-closure ledger that combines method, display, dashboard, grade-basis, station-context, and installation/audit gates while keeping station-specific certificates and complete-grade rows at zero, an 8-source targeted BMKG certificate/status scan that adds exact Kototabang maintenance/calibration context but still finds 0 station-specific PM2.5 certificate/status rows, an 8-source BMKG PPID/PTSP access-route wall that maps public PM2.5 display, calibration-service context, certificate-request context, raw-data access limits, and 0 station-specific certificate/status rows, a 16-row Georgia report-verification scan, a 24-month Georgia report/export ladder, a 5-source Georgia verification-policy wall, a 24-probe Georgia report-frequency matrix, an 8-source Georgia NEA station network/launch scan with 15 public-context rows and 0 station-code/status/grade closures, a 2-route Georgia indicator endpoint mismatch scan that parses 136 indicator station objects but finds 0 exact target station-code matches, a 24-economy station-radius denominator readiness wall, a 7-source denominator source plan that names population, PM2.5, context, and boundary inputs, a 7-source acquisition-route scan with 87 visible route links, 4/4 candidate denominator sources with visible routes, 33 HEAD probes, and 20 probe-OK responses, a file-manifest prefreeze with 12 manifest rows, 10 exact public file/object records, 5 exact population files, 4 current ACAG AWS PM2.5 objects with source-plan version drift, 2 unresolved Box shared-folder routes, a download-feasibility gate with 4 first-wave candidates, and an ACAG version-decision gate that selects 2 current V6.GL.03 2023 coarse PM2.5 checksum candidates while keeping 2024 visible but unselected and keeping downloads/checksums/joins/maps at zero before a monitoring-gap claim is widened.",
    evidencePath: "air-monitoring/station-radius-acag-version-decision.md",
    visual: "Zero-monitor exposure bars, GDP residual scatter, metadata-readiness wall, OpenAQ coordinate map, station-radius denominator readiness wall, source-plan wall, acquisition-route wall, and file-manifest ledger, regulator-source wall, official-source bars, official/OpenAQ reconciliation ladder, candidate station-crosswalk worksheet, public-evidence attachment, isMonitor source-scan decisions, public-feed source-scan decisions, one-signal review wall, monitor-grade evidence ladder, monitor-grade source-validation wall, station-review wall, exact station method-evidence bridge, Uzbekistan stale-reading date wall, station-specific source-evidence wall, status/certification source ladder, 3-row blocker wall, official endpoint disagreement wall, external launch-versus-closure wall, Air Uzbekistan portal namespace wall, Indonesia/Georgia method-context wall, station-code status/method wall, station-grade decision ledger, station-method classification audit, BMKG operation/maintenance source wall, BMKG station display/certification wall, BMKG API field wall, BMKG regional status/analysis wall, BMKG dashboard current-status wall, BMKG grade-basis source wall, BMKG station public-context wall, BMKG installation/audit source wall, BMKG near-closure evidence-gate ledger, BMKG targeted certificate/status search wall, BMKG PPID/PTSP access-route wall, Georgia report-verification wall, Georgia report/export ladder, Georgia verification-policy bridge, Georgia report-frequency matrix, Georgia NEA network/launch wall, and Georgia indicator endpoint namespace wall",
    sourceNote: "OpenAQ v3 locations, public regulator and official portal station tables/APIs, Uzhydromet API, Uzhydromet English/Russian/Uzbek station-detail and regional table pages, gov.uz ecology event and commissioning notes, gov.uz Sergeli/Uchtepa automatic-station launch pages, World Bank Tashkent assessment text, UNDP Aral Sea monitoring launch page, Digital Government portal page, BMKG PM2.5 portal/station-detail pages, BMKG public app token route and PM2.5 list/detail APIs, BMKG observation regulation, BMKG technical and operational maintenance standard, BMKG daily BAM-1020 inspection SOP, BMKG calibration service/tariff page, BMKG source-level instrument notes, BMKG PNBP tariff regulation, BMKG Kalimantan Selatan regional PM2.5 status page and UPT profile, BMKG Bengkulu, South Sumatra, and West Kalimantan regional PM2.5 analysis pages/bulletin, BMKG climate-information PM2.5 parent page, BMKG CEWS PM2.5 dashboard HTML and embedded dashboardData object, BMKG PPID public-information list and reports, BMKG PPID excluded-information consequence test, BMKG PTSP service/tariff page, BMKG annual-report certificate and PM2.5 context, GAW Bukit Kototabang maintenance page and station publications, Universitas Jambi and KESANS Jambi station studies, Megasains Sorong station article, BRIN West Kalimantan station study, Jakarta environment-agency air-quality report, BMKG Kototabang WMO audit/calibration article, BMKG 2020 annual report PM2.5 installation section, BMKG NOC/AWS/public-information/calibration routes, BMKG station-detail raw HTML caches and station-specific status audit records, air.gov.ge station-code API, air.gov.ge monthly report route and XLSX/PDF export routes, air.gov.ge daily/monthly/annual report-frequency routes, air.gov.ge indicator and daily API routes, air.gov.ge report generator, air.gov.ge monitoring-network and index notes, air.gov.ge Tbilisi plan landing, MEPA Tbilisi air-quality management plan PDF, NEA/MoEPA Georgia sources, NEA current-network and station-launch pages, Bangladesh, Sri Lanka, Uzhydromet, CEA, Brunei, Malaysia, and Tajikistan source-language checks, GHSL GHS-POP, WorldPop Global2, ACAG SatPM2.5, AWS Registry, SATPM V6.GL.03 documentation, ACAG satpmdata S3 prefix listings, ACAG Box shared-folder routes, WHO DIMAQ and Ambient Air Quality Database pages, Natural Earth boundary references, GHSL CIDPortal exact archive/tile URLs, WorldPop R2025A exact archive and metadata URLs, WHO context file routes, WDI, and committed source artifacts",
  },
  {
    id: 7,
...
export const showcaseReportDepth: Record<number, ShowcaseReportDepth> = {
  ...
  6: {
    ...
    limitation: "Ground-monitor visibility is not pollution ranking, compliance assessment, or monitor siting adequacy; the reconciliation audit has candidate rows but zero validated joins, the exact-row method audit and decision ledger find raw-value and blocker issues, the Uzbekistan station-specific scan closes the station-ID gate through official detail URLs, the status/certification, blocker, endpoint-consistency, external-context, and Air Uzbekistan portal namespace scans add context but still lack explicit current-status and grade closure, the Indonesia/Georgia and station-code scans add exact public row context without grade closure, BMKG station/API telemetry is visible but lacks status/certificate fields, the BMKG near-closure ledger makes 22 method/display rows and 21 ONLINE dashboard rows visible but still has zero public station-specific certificates, calibration-status rows, complete-grade rows, or station-radius-ready rows, the Georgia report/export ladder keeps verified-report closure at zero, the Georgia verification-policy wall confirms the policy route but not a station-status or verified-closure route, the Georgia report-frequency matrix finds no daily, monthly, annual, XLSX, or PDF closure route, the Georgia NEA network/launch scan adds city-level context but no station-code/status/calibration/grade closure, and the station-radius denominator source plan, acquisition-route scan, and file-manifest prefreeze make exact public file/object records visible but still record 0 downloaded denominator files, 0 SHA-256 denominator checksums, 0 gridded population denominator files, 0 gridded PM2.5 denominator files, 0 validated joins, 0 complete monitor-grade rows, and 0 station-radius-ready economies.",
  },
  7: {
...
export const showcaseReportQuality: Record<number, ShowcaseReportQuality> = {
  ...
  6: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
    qaSummary: "Air-monitoring has deepening artifacts, a metadata-readiness audit, an OpenAQ station-metadata source pass, regulator-source discovery, official station-source extraction, official/OpenAQ reconciliation audit, a 13-row candidate station-crosswalk review worksheet, public OpenAQ metadata evidence for those candidates, public source scans that screen the 6 OpenAQ isMonitor rows and the 7 not-isMonitor public-feed rows as not join-ready, a 169-item one-signal review queue, monitor-grade evidence audit, a 14-source monitor-grade source-validation scan, a 138-row station-review queue, a 66-row exact station method-evidence and raw-live-value sanity audit, a 28-row Uzbekistan current/method scan, a Uzbekistan method-policy source scan, a Uzbekistan station-specific source evidence scan with 28 official station-detail ID matches and 26 detail measurements within 30 days, a Uzbekistan status/certification source scan with 7 retrieved context sources and 0 current-status or complete-grade rows, a Uzbekistan blocker follow-up with 2 stale detail rows, 1 sentinel PM2.5 row, and 0 resolved blockers, a 3-row Uzbekistan endpoint-consistency check with 16 retrieved official routes, 3 API/detail date mismatches, 2 API/detail PM2.5 mismatches, 3 region/detail status mismatches, and 0 endpoint-resolution rows, a 4-source Uzbekistan external-context wall with 2 context rows, 0 exact station-ID context rows, 0 blocker-resolution rows, and 0 current-status or complete-grade rows, a 4-source Air Uzbekistan portal namespace wall with 28 portal station objects, 3 alternate namespace matches, 3 mirrored blocker details, 0 original blocker-ID detail hits, and 0 closure rows, a 38-row Indonesia/Georgia row-method source scan with 22 BMKG same-page method-context candidates and 0 complete-grade rows, a 41-row station-code scan, a 66-row station-grade decision ledger, a 66-row station-method classification audit with 22 BMKG method-classified rows and 0 complete-grade rows, a 22-row BMKG operation/maintenance source scan with 26 retrieved source records and 0 station-specific calibration/status rows, a 22-row BMKG station-specific status audit with 22 parsed public display snapshots and 0 station-specific certificate/status closures, a 22-row BMKG API parity/status check with 24 official API routes retrieved, 22 target detail API routes, 132 hourly PM2.5 observations, 21 target station files in the list API, 3 extra list API station files, and 0 status/calibration/certificate/grade/method fields, a 10-source BMKG regional status/analysis scan with 5 station/site context rows, 3 regional-analysis context rows, 1 Banjarbaru current-status closure, and 0 inspection/calibration/complete-grade/radius rows, a 2-source official BMKG dashboard status scan with 26 dashboard locations parsed, 22 target dashboard rows matched, 21 current ONLINE rows, 1 current DELAYED row, 2,640 target time-series observations, and 0 inspection/calibration/complete-grade/radius rows, a 10-source BMKG grade-basis scan with 8 method-basis sources, 7 technical/operational standard sources, 3 daily inspection or logbook rule sources, 2 periodic calibration rule sources, 2 public calibration service route sources, 2 certificate-context sources, and 0 station-specific calibration/status or complete-grade rows, a 16-source BMKG station public-context scan with 11 public station or deployment context rows, 7 station-unit/exact-context rows, 6 city/deployment context rows, 11 method-context rows, 7 calibration-language context rows, and 0 station-specific calibration/status or complete-grade rows, a 6-source official BMKG installation/audit scan with 1 exact station audit/calibration context row, 7 PM2.5 installation/deployment context rows, 4 source-level operational or calibration routes, and 0 station-specific calibration/status or complete-grade rows, a 22-row BMKG near-closure ledger with 22 method-classified rows, 22 detail-display rows, 21 current ONLINE dashboard rows, 1 DELAYED row, 7 station-unit/exact-context rows, 1 exact audit/calibration context row, 7 PM2.5 installation/deployment rows, and 0 station-specific inspection-log, calibration-certificate/status, complete-grade, or radius-ready rows, an 8-source BMKG PPID/PTSP access-route wall with 1 public PM2.5 catalog route, 1 public station-display route matching all 22 target rows, 1 calibration-service route, 1 certificate-request context source, 2 raw-data access-limit context sources, and 0 station-specific calibration/status rows, a 16-row Georgia report-verification scan with 16 PM2.5 report rows, 16 not-verified caution rows, and 0 verified closures, a 24-month Georgia report/export ladder with 24 not-verified HTML months, 3 XLSX export probes, 3 PDF not-verified export probes, and 0 verified closures, a 5-source Georgia verification-policy wall with 5 official routes retrieved, 1 live-data caution source, 1 reports-as-verified-data source, 24 not-verified HTML months, 3 PDF caution probes, and 0 verified closure/status/grade/radius rows, a 24-probe Georgia report-frequency matrix with 12 valid daily/monthly payloads, 12 annual server-error probes, 8 HTML/PDF not-verified payloads, 4 XLSX station-sheet exports, 0 XLSX verification labels, and 0 verified closure routes, an 8-source Georgia NEA station network/launch scan with 15 official city/source-context rows, 13 launch-context rows, 15 current-network city rows, 0 station-code rows, and 0 verified/status/calibration/complete-grade/radius rows, a 2-route Georgia indicator endpoint mismatch scan with 136 indicator station objects, 14 city-alias context rows, 0 exact target station-code matches, and 0 verified/status/calibration/complete-grade/radius closure rows, a station-radius denominator readiness wall with 101 OpenAQ coordinate rows, 230 official coordinate rows, 22 official/OpenAQ proximity candidate rows, 0 validated same-station joins, 0 complete monitor-grade rows, 0 gridded population denominator files, 0 gridded PM2.5 denominator files, and 0 station-radius-ready economies, a 7-source denominator source plan with 2 population candidates, 2 PM2.5 candidates, 2 context-only WHO sources, 1 boundary-reference source, and 0 raster or grid files pinned, a 7-source acquisition-route scan with 87 visible route links, 33 HEAD probes, and 20 probe-OK responses, a file-manifest prefreeze with 12 manifest rows, 10 exact public file/object records, 5 exact population files, 4 current ACAG AWS PM2.5 objects with source-plan version drift, 2 unresolved Box shared-folder routes, and 0 downloads/checksums/joins/maps, and a bespoke observability report with concentration, residual, exposure, gate, coordinate, source-wall, candidate-reconciliation, review-queue, public-evidence, source-scan, public-feed, one-signal, grade-evidence, source-validation, station-review, exact-row method-evidence, station-radius denominator readiness, station-radius denominator source plan, station-radius denominator acquisition routes, station-radius denominator file-manifest prefreeze, Uzbekistan stale-reading, station-specific source-evidence, status/certification, blocker, endpoint consistency, external context, Air Uzbekistan portal namespace, Indonesia/Georgia method-context, station-code, decision-ledger, method-classification, BMKG operation/maintenance, BMKG station display/certification, BMKG API field wall, BMKG regional status/analysis wall, BMKG dashboard status wall, BMKG grade-basis source wall, BMKG station public-context wall, BMKG installation/audit source wall, BMKG near-closure ledger, BMKG PPID/PTSP access-route wall, Georgia report-verification, Georgia report/export ladder, Georgia verification-policy bridge, Georgia report-frequency matrix, Georgia NEA network/launch, and Georgia indicator endpoint mismatch panels.",
    publicationGap: "Needs validated station crosswalk rows, station-level complete monitor-grade classification across sources, a selected gridded population denominator, a resolved ACAG V6.GL.03/V6.GL.02.04/V5 version decision, downloaded and SHA-256 checksummed denominator files, frozen radius/de-duplication/join/grade rules, and denominator validation before station-radius or catchment language.",
    nextUpgrade: "For Uzbekistan, find a public station-owner or regulator source beyond the Air Uzbekistan alternate namespace that names station IDs 107, 728, or 737, or explicitly crosswalks them to IDs 1, 20, and 26, with correction/status/calibration or grade-basis closure; for BMKG, target station-specific inspection logs, PM2.5 calibration certificates, calibration-status records, or explicit station-grade records beyond station pages, dashboard status, station studies, installation/deployment context, source-level rules, and the PPID/PTSP access-route wall; for Georgia, find a station-specific verified report/status/method route beyond the policy note, daily/monthly caution routes, annual server-error routes, XLSX station-sheet-only exports, NEA city-level network/launch context, and the indicator API's different station-code namespace; for station-radius work, use the download-feasibility gate to resolve the ACAG current-version decision, treat the GHSL tile as route-test only, select a DMC-intersecting population tile/subset, then checksum only the selected denominator subset before any catchment map.",
  },
  7: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
