"""Download Bangladesh-intersecting Google Open Buildings V3 point shards.
...
MANIFEST_JSON = ROOT / "generated" / "psdq-bgd-open-buildings-tile-manifest.json"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--workers", type=int, default=2, help="Concurrent downloads.")
