...
1. Air-monitoring observability, because the source walls now identify the
   ...
   station/deployment context, but still needs station-specific inspection,
   calibration, calibration-status, certificate, or explicit station-grade
   records for complete-grade promotion;
