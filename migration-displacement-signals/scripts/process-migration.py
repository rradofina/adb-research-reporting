...
CACHE = "D:/Users/Raymond/OneDrive/Desktop/ADB/Research/migration-displacement-signals/.cache"
OUT = "D:/Users/Raymond/OneDrive/Desktop/ADB/Research/migration-displacement-signals/generated"
...
def main():
    wb = openpyxl.load_workbook(f"{CACHE}/undesa_migrant_stock_2024_destination.xlsx", data_only=True)
    ws = wb["Table 1"]
    ...
    with open(f"{OUT}/migration-displacement-adb-panel.json", "w", encoding="utf-8") as f:
    ...
    with open(f"{OUT}/migration-displacement-adb-panel.csv", "w", encoding="utf-8", newline="") as f:
