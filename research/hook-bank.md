...
| 1 | PSDQ source disagreement | `public-service-data-quality/source-disagreement-l3-module.md`, `generated/psdq-bgd-source-disagreement-strata.{json,csv}`, and PSDQ national summary | Interactive registry-vs-OSM disagreement workbench plus ratio-strata validation ledger | L3 evidence module at `/showcase/psdq-source-disagreement`; desktop/mobile screenshot QA complete on 2026-06-19 | Facility-level validation sample: high-gap rows, zero-OSM rows, registry vintage, and OSM-above-registry counterexamples |
