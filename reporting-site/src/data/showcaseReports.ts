...
export const showcaseReportQuality: Record<number, ShowcaseReportQuality> = {
  ...
  6: {
    ...
    nextUpgrade: "Search station-owner or regulator documentation that states current operating status, calibration/status records, or station-specific certification beyond the official regional table and detail pages, then resolve the 38 Indonesia/Georgia PM2.5 portal/API rows without promoting any catchment denominator until grade evidence is complete.",
  },
  7: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
