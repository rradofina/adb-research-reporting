...
| 2 | Air-monitoring observability | `air-monitoring/deepened-results.md`, `air-monitoring/metadata-readiness-audit.md`, `air-monitoring/generated/air-monitoring-concentration-deepening.json`, `air-monitoring/generated/air-monitoring-adb-panel.json`, and `air-monitoring/generated/air-monitoring-metadata-readiness-audit-summary.json` | Zero-monitor population concentration stack plus GDP-adjusted monitor-density residual scatter, exposure/monitor-count panel, and station-metadata readiness wall | Prototype surface at `/showcase/air-monitoring-observability`; metadata-readiness audit generated with 24 upgrade-queue rows and 0 station-coordinate/grade/vintage/regulatory-inventory rows; desktop/mobile CDP screenshot QA complete | L3 station-metadata package: fetch and version station coordinates, grade/owner, first-seen or vintage metadata, gridded population/PM2.5 denominators, and OpenAQ-vs-regulatory inventory validation before station-radius claims |
