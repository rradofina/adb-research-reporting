...
| 2 | Measured digital development gap | `digital-performance/` (memo; legacy SQL at `luminosity-gap/research/digital-performance/`) | PP — pipeline-required (Ookla parquet 2.6 GB needs DuckDB execution; see `digital-performance/NEGATIVE-RESULT.md`) | pending | Adofina | 2026-04-27 |
...
| 6 | Coastal informal settlement risk | `coastal-informal-risk/` | **SR under §18** (31 of 50 coastal DMCs ranked; top-5 set {BGD, CHN, MMR, PAK, PHL} stable across ±50% slum-imputation; LECZ via CIESIN SEDAC is §18.5 upgrade; `/program/coastal-informal-risk/evidence`; `attestation_chain: ai-first`) | 17/30 (AI under §18) | Adofina | 2026-04-26 |
...
| 9 | Food price climate transmission | `food-price-climate-transmission/` | **PP — sensitivity-gate failure** (no stable top-5 under ±50%; documented in `food-price-climate-transmission/NEGATIVE-RESULT.md`; index design needs reformulation) | pending reformulation | Adofina | 2026-04-26 |
