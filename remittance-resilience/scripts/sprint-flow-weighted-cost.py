"""L2 hook sprint: remittance corridor costs after bilateral-flow weighting.

This is exploratory hook triage, not a promoted program claim.
...
def write_chart(rows):
    ...
    ax.text(
        ...
        "Low matched-flow coverage remains a caveat for one-corridor economies. Exploratory L2 hook sprint; not a promoted claim.\n"
...
def main():
    ...
    payload = {
        ...
        "status": "promote_to_L3_repair_pass",
        "decision": (
            f"The hook is not generic: {matched_count} of {corridor_count} "
            "ADB-DMC-bound RPW latest-period corridors join to public KNOMAD "
            "bilateral-flow estimates, and flow weighting changes both costs "
            "and rank order enough to require a full remittance-resilience "
            "repair pass before public reframing."
        ),
        ...
        "method": {
            ...
            "normalization_note": (
                "RPW costs use the corrected sprint parser: multiply by 100 "
        ...
        "source_sanity": {
            ...
            "knomad": (
                ...
                "in US$ million. It is suitable for a flow-weighting sprint, "
            ...
            "use_limit": (
                "This sprint can decide whether the hook deserves an L3 "
                "repair pass. It cannot by itself support a public headline "
