  ...
  return (
    <div className="reveal">
      ...
      <section className="mb-10 flex flex-wrap items-center gap-3">
        <Link to="/briefs" className="ed-link text-sm uppercase tracking-[0.16em] font-mono">
          Research Briefs
        </Link>
        <Link to="/data" className="ed-link text-sm uppercase tracking-[0.16em] font-mono">
          Data catalog
        </Link>
        <Link to="/data/matrix" className="ed-link text-sm uppercase tracking-[0.16em] font-mono">
                ...
                <tr key={program.slug}>
                  <td className="align-top min-w-[210px]">
                    <div className="flex items-baseline gap-3">
                      ...
                      <div>
                        <Link
                          to={program.href ?? `/program/${program.slug}/evidence`}
