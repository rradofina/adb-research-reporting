...
export const showcaseReportQuality: Record<number, ShowcaseReportQuality> = {
  ...
  4: {
    ...
    publicationGap: "Needs owner-only source-owner contact or human validation for the Durgapur same-name cross-district coordinate conflict and shared-coordinate Narayanganj records, plus registry-vintage notes and independent validation before stronger access-map use.",
    nextUpgrade: "Prepare an internal review checklist or registry-vintage note while keeping the unresolved Durgapur and Narayanganj rows out of same-facility or map-absence language.",
  },
  5: {
    readiness: "l3-candidate",
    readinessLabel: "L3 candidate",
