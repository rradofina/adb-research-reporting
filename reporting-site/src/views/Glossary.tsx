...
const TERMS: Term[] = [
  ...
  { term: "ai-first", body: "Attestation chain under Constitution §18. Gate actions are AI-attested and disclosed rather than implied as human-final. Current public issue surfaces 16 computed outputs under this chain: 7 finished, 8 screening-only, and 1 prospectus. Two registered tracks are held back as pipeline or hypothesis.", see: [{ label: "Reader's guide §3", to: "/how-to-read" }] },
