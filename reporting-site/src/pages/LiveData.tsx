  ...
  return (
    ...
    >
      ...
      <ul className="mt-4 marginalia space-y-1.5">
        <li>
          → <Link to="/atlas" className="ed-link">DMC atlas</Link> — every
          country, all 14 indicators, rendered from <code>/public/data/*.json</code>
        </li>
        <li>
          → <Link to="/research" className="ed-link">Research programs</Link> —
          per-program panel data, sensitivity, and evidence packets
        </li>
        <li>
          → <Link to="/data" className="ed-link">Data catalog</Link> — every
          published JSON file with its source license and retrieval timestamp
        </li>
        <li>
          → <Link to="/findings" className="ed-link">Findings</Link> — the working-paper series
        </li>
      </ul>
      <p
