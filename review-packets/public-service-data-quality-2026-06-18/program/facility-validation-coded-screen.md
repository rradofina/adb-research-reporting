...
public-source/manual confirmation of the first inspection rows, using the DGHS
profile links, OSM coordinate links, and candidate-feature notes before
revising any PSDQ source-disagreement claim.
