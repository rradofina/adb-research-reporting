  ...
  return (
    <div className="reveal">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-10">
        ...
        <Link to="/research" className="ml-auto ed-link text-sm uppercase tracking-[0.16em] font-mono">
          Program index
        </Link>
        <Link to="/data/upgrades" className="ed-link text-sm uppercase tracking-[0.16em] font-mono">
          Data upgrades
        </Link>
      </div>
            ...
            >
              ...
              <div className="col-span-12 lg:col-span-5">
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  {detail.articleSlug && (
                    <Link
                      to={`/findings/${detail.articleSlug}`}
                  ...
                  <Link
                    to={`/program/${program.slug}/evidence`}
                    className="ed-link text-sm uppercase tracking-[0.16em] font-mono"
                  >
                    Evidence packet
                  </Link>
