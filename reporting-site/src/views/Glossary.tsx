...
const TERMS: Term[] = [
  ...
  { term: "PR", expansion: "Internal Publication-Ready code", body: "Public UI label: Publication-ready. The evidence package is complete for the stated attestation chain; human-final publication status requires the §18.5 upgrade path.", see: [{ label: "Methods", to: "/methods" }] },
  ...
  { term: "ai-first", body: "Attestation chain under Constitution §18. Gate actions are AI-attested and disclosed rather than implied as human-final. The constitutional program register currently distinguishes publication-ready, screening-result, prepared-pipeline, and hypothesis programs; that register, not page metadata, controls the public label.", see: [{ label: "Reader's guide §3", to: "/how-to-read" }] },
