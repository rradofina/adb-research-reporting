...
const DATASETS: DatasetRow[] = [
  ...
  { slug: "itu-datahub", name: "ITU DataHub ICT Indicators", publisher: "International Telecommunication Union", url: "https://datahub.itu.int/", license: "ITU public data", access: "A", programs: ["digital-performance"], note: "Public v2 API; this study pins response URLs, retrieval times, bytes, and SHA-256 digests." },
