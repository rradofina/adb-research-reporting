...
| 2 | Air-monitoring observability | `air-monitoring/deepened-results.md`, `air-monitoring/metadata-readiness-audit.md`, `air-monitoring/station-metadata-source-access.md`, `air-monitoring/regulator-source-inventory.md`, `air-monitoring/regulator-station-extraction.md`, `air-monitoring/official-openaq-reconciliation.md`, `air-monitoring/official-openaq-candidate-review.md`, `air-monitoring/official-openaq-candidate-public-evidence.md`, `air-monitoring/monitor-grade-evidence.md`, `air-monitoring/generated/air-monitoring-concentration-deepening.json`, `air-monitoring/generated/air-monitoring-adb-panel.json`, `air-monitoring/generated/air-monitoring-metadata-readiness-audit-summary.json`, `air-monitoring/generated/air-monitoring-openaq-station-metadata-summary.json`, `air-monitoring/generated/air-monitoring-regulator-source-inventory-summary.json`, `air-monitoring/generated/air-monitoring-regulator-station-extraction-summary.json`, `air-monitoring/generated/air-monitoring-official-openaq-reconciliation-summary.json`, `air-monitoring/generated/air-monitoring-official-openaq-candidate-review-summary.json`, `air-monitoring/generated/air-monitoring-official-openaq-candidate-public-evidence-summary.json`, and `air-monitoring/generated/air-monitoring-monitor-grade-evidence-summary.json` | Zero-monitor population concentration stack plus GDP-adjusted monitor-density residual scatter, exposure/monitor-count panel, station-metadata readiness wall, OpenAQ station-coordinate map, regulator-source gap wall, official-source bars, official/OpenAQ reconciliation ladder, candidate station-crosswalk worksheet, public-evidence attachment, and monitor-grade evidence ladder | Prototype surface at `/showcase/air-monitoring-observability`; station-metadata source pass generated 101 OpenAQ PM2.5 station rows and 101 coordinate rows for 11 of 24 upgrade-queue economies, excluded 2 coordinate-QC rows, with 13 economies still at OpenAQ-visible zero; regulator-source discovery found 9 official inventory/portal candidates, 6 station-count claim rows, 0 monitor-grade classification rows, and 11 targeted-search gaps; official station-source extraction then retrieved 9 targeted official sources, normalized 230 official coordinate rows across 5 economies, kept 6 station name-only rows, 1 count-only row, and 2 plan-count-only rows separate, and found 22 official coordinate rows within 5 kilometers of OpenAQ as a screening diagnostic; official/OpenAQ reconciliation audit classifies 13 near-plus-name candidate rows, 9 near-only candidate rows, 22 name-only-not-near candidate rows, 186 official coordinate rows without either candidate signal, and 0 validated same-station joins; candidate review worksheet turns the 13 near-plus-name rows into reviewer questions across 4 economies while recording 0 station-ID crosswalk rows, 0 public current-status confirmations, 0 validated same-station joins, and 0 station-radius-ready rows; candidate public-evidence audit attaches OpenAQ metadata to those 13 rows and finds 13 owner/provider rows, 6 OpenAQ `isMonitor` true rows, 7 not-`isMonitor` rows, 0 exact station-ID overlaps, 0 explicit crosswalk rows, and 0 station-radius-ready rows; monitor-grade audit covers 239 official-source rows, finds 31 source-specific method-standard signal rows in Bangladesh, 138 automatic or official-portal signal-only rows, 3 sensor-under-test rows, 2 plan-only rows, 65 rows with no public grade language, and 0 complete monitor-grade classification rows; station map/source wall/reconciliation, official/OpenAQ, candidate-review, candidate-public-evidence, and monitor-grade panel desktop-mobile QA complete | L3 source-validation package: validate near-plus-name candidate rows from the worksheet and public-evidence audit, deepen non-Bangladesh monitor-grade documentation, and add gridded population/PM2.5 denominators only after source comparison survives |
